...
@section('title', 'Servis Pengiriman')
@section('content')
  <div class="row">
    <div class="col col-lg col-md">
      <div class="card mb-3">
        <div class="card-body">
          ...
          <p class="mb-1">Provinsi Asal : {{ $response['origin_details']['province'] }}</p>
          <p class="mb-1">Kota Asal : {{ $response['origin_details']['city_name'] }}</p>
          <p class="mb-1">Kode Pos : {{ $response['origin_details']['postal_code'] }}</p>
        </div>
      </div>
    </div>
    <div class="col col-lg col-md">
      <div class="card">
        <div class="card-body">
          ...
          <p class="mb-1">Provinsi Tujuan : {{ $response['destination_details']['province'] }}</p>
          <p class="mb-1">Kota Tujuan : {{ $response['destination_details']['city_name'] }}</p>
          <p class="mb-1">Kode Pos : {{ $response['destination_details']['postal_code'] }}</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <table class="table">
          ...
          <tbody>
            <tr class="even">
              ...
              <td>
                <span class="text-capitalize text-dark">{{ $response['results'][0]['name'] }}</span>
              </td>
            </tr>
          </tbody>
          <tr>
      ...
      <div class="col col-lg col-md">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <p class="mb-3 courier-cost">Biaya : Rp {{ number_format($response['results'][0]['costs'][0]['cost'][0]['value'], 0, ',', '.') }}</p>
      ...
      <div class="col col-lg col-md">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <p class="mb-3 courier-cost">Biaya : Rp {{ number_format($response['results'][0]['costs'][1]['cost'][0]['value'], 0, ',', '.') }}</p>
            <button type="submit" class="btn btn-sm btn-primary choose-service">Pilih Servis</button>
          </div>
        </div>
      </div>
      ...
      <div class="col col-lg col-md">
        <div class="card">
          <div class="card-body">
            ...
            @endif
            <p class="mb-3 courier-cost">Biaya : Rp {{ number_format($response['results'][0]['costs'][2]['cost'][0]['value'], 0, ',', '.') }}</p>
            <button type="submit" class="btn btn-sm btn-primary choose-service">Pilih Servis</button>
          </div>
        </div>
      </div>
