    ...
    @if ($data['foodProducts']->count() >= 4)
      <section class="pt-5" data-aos="fade-up" data-aos-duration="1000">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('guest.products', ['category' => 'makanan']) }}" class="btn btn-primary btn-sm mb-4">
            Lihat Semua
          </a>
        </div>
    ...
    @if ($data['beautyProducts']->count() >= 4)
      <section data-aos="fade-up" data-aos-duration="1000">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('guest.products', ['category' => 'kecantikan']) }}" class="btn btn-primary btn-sm mb-4">
            Lihat Semua
          </a>
        </div>
        <x-grid-card :class="'mb-5'">
