      ...
      <table class="table">
        <thead class="table-light">
          <tr>
            ...
            {{-- <th class="text-truncate">PPN 1%</th>
            <th class="text-truncate">PPN 1% * Quantity</th> --}}
            <th class="text-truncate">Harga Total</th>
            <th class="text-truncate">Harga Total + (PPN * Quantity)</th>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-center cursor-pointer" onclick="window.location.href='{{ route('midtrans.checkout', $data->uuid) }}'">
              ...
              {{-- <td><span class="text-truncate text-dark">Rp {{ number_format($data->fee, 0, ',', '.') }}</span></td>
              <td>
