      ...
      <tbody>
        @foreach ($datas as $data)
          <tr>
            ...
            <td>
              <img src="{{ asset('storage/' . $data->image) }}" width="75" class="img-fluid rounded">
              <span class="fw-medium">{{ $data->name }}</span>
            </td>
            <td>
              <span class="fw-medium">{{ $data->description }}</span>
            </td>
            <td>
              <span class="fw-medium">{{ $data->price }}</span>
            </td>
            <td>
              <span class="fw-medium">{{ $data->stock }}</span>
            </td>
            <td>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <x-dropdown-item :label="'Edit'" :variant="'warning'" :icon="'pencil-outline'" :route="route('admin.edit.product', $data->slug)" />
