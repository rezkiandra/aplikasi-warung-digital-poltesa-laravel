      ...
      <ul class="p-0 m-0">
        <li class="d-flex mb-4 pb-md-2">
          <div class="avatar flex-shrink-0 me-3">
            <img src="{{ asset('materio/assets/img/icons/misc/zipcar.png') }}" alt="zipcar" class="rounded">
          </div>
        ...
        <li class="d-flex mb-4 pb-md-2">
          <div class="avatar flex-shrink-0 me-3">
            <img src="{{ asset('materio/assets/img/icons/misc/bitbank.png') }}" alt="bitbank" class="rounded">
          </div>
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
        ...
        <li class="d-flex mb-md-3">
          <div class="avatar flex-shrink-0 me-3">
            <img src="{{ asset('materio/assets/img/icons/misc/aviato.png') }}" alt="aviato" class="rounded">
          </div>
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
