  ...
  <nav class="layout-navbar shadow bg-white rounded border">
    <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-3 px-md-4 bg-white rounded">
      <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
        ...
        <a href="<?php echo e(route('guest.home')); ?>" class="app-brand-link gap-3 me-lg-0 me-0">
        ...
        <ul class="navbar-nav d-lg-flex align-items-center justify-content-between gap-4 d-inline">
          <li class="nav-item my-lg-0 my-2">
            <a class="nav-link fw-medium <?php echo e(request()->routeIs('guest.home', 'customer.home') ? 'active text-primary' : 'text-dark'); ?>"
              href="<?php if($user_role == 3): ?> <?php echo e(route('customer.home')); ?> <?php else: ?> <?php echo e(route('guest.home')); ?> <?php endif; ?>">Home</a>
          </li>
          ...
          <li class="nav-item my-lg-0 my-2">
            <a class="nav-link fw-medium text-dark <?php echo e(request()->routeIs('guest.products', 'customer.products', 'guest.*.product', 'customer.*.product') ? 'active text-primary' : 'text-dark'); ?>"
              href="<?php if($user_role == 3): ?> <?php echo e(route('customer.products')); ?> <?php else: ?> <?php echo e(route('guest.products')); ?> <?php endif; ?>">Products</a>
          </li>
      ...
      <ul class="navbar-nav d-flex d-lg-flex d-md-flex align-items-center ms-auto">
        <li>
          ...
          <?php endif; ?>
          <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('customer.cart')); ?>" class="me-4">
...
<?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/components/navbar-guest.blade.php ENDPATH**/ ?>