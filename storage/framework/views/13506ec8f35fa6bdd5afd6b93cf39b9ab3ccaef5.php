...
<?php $component = $__env->getContainer()->make(App\View\Components\DetailOrderItem::class, ['label' => 'Total','icon' => 'basket-outline','class' => 'border-end','variant' => 'info','condition' => $countOrder]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginale6969076d4a8770d4356b03ef5c1f0fb4d210e4f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DetailOrderItem::class, ['label' => 'Selesai','icon' => 'basket-check-outline','class' => 'border-end','variant' => 'success','condition' => $countPaid]); ?>
<?php $component->withName('detail-order-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginale6969076d4a8770d4356b03ef5c1f0fb4d210e4f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DetailOrderItem::class, ['label' => 'Belum Bayar','icon' => 'basket-off-outline','class' => 'border-end','variant' => 'danger','condition' => $countUnpaid]); ?>
<?php $component->withName('detail-order-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginale6969076d4a8770d4356b03ef5c1f0fb4d210e4f = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DetailOrderItem::class, ['label' => 'Dibatalkan','icon' => 'basket-remove-outline','class' => 'border-end','variant' => 'dark','condition' => $countCancelled]); ?>
<?php $component->withName('detail-order-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
