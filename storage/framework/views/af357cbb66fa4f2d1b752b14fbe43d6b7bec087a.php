      ...
      <tbody>
        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            ...
            <td>
              <span class="fw-medium"><?php echo e(\App\Models\Seller::where('id', $data->parent_id)->count()); ?></span>
            </td>
            <td><span
...
<?php $component = $__env->getContainer()->make(App\View\Components\DropdownItem::class, ['label' => 'Edit','variant' => 'warning','icon' => 'pencil-outline','route' => route('admin.edit.bank', $data->slug)]); ?>
...
<?php endif; ?>
                  <?php if (isset($component)) { $__componentOriginal449bfa6e40fc6b9502e7641b2b70c69491540e98 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\DropdownItem::class, ['label' => 'Detail','variant' => 'secondary','icon' => 'eye-outline','route' => route('admin.detail.bank', $data->slug)]); ?>
<?php $component->withName('dropdown-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php /**PATH C:\laragon\www\warungdigital\resources\views/components/bank/bank-table.blade.php ENDPATH**/ ?>