...
<?php $component = $__env->getContainer()->make(App\View\Components\CustomerTable::class, ['title' => 'Data Pelanggan','datas' => $customers,'fields' => ['No', 'Pelanggan', 'Gender / Alamat', 'Status / Nomor HP', 'Bank', 'Dibuat Pada', 'Aksi']]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>