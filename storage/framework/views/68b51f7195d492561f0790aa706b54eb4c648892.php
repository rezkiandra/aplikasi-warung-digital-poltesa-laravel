...
<?php $__env->startSection('content'); ?>
  <section id="hero" class="mb-5 pb-5">
    <div class="container mt-lg-5 mt-1 pt-4">
      <div class="mt-3 pt-5 text-center">
        <h1 class="text-primary mb-5">All in one application for<br />your business</h1>
        <h6 class="text-dark mb-2">No coding required to make your business grow.</h6>
        <h6 class="text-dark mb-4">The live customiser has everything your marketing need.</h6>
        <a href="" class="btn btn-primary text-uppercase">Get Early Access</a>
      </div>
    </div>
  </section>
  ...
  <section id="features" class="mb-5">
    <div class="container">
      <h6 class="text-center fw-semibold d-flex justify-content-center align-items-center mb-4">
        <i class="mdi mdi-checkbox-marked-circle-outline me-2 mdi-24px"></i>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-3 col-sm-6 text-center">
          <div class="mb-3">
            <i class="mdi mdi-code-block-tags me-2 fs-1 text-primary"></i>
          </div>
        ...
        <div class="col-lg-3 col-sm-6 text-center">
          <div class="features-icon mb-3">
            <i class="mdi mdi-update text-primary me-2 fs-1"></i>
          </div>
        ...
        <div class="col-lg-3 col-sm-6 text-center">
          <div class="features-icon mb-3">
            <i class="mdi mdi-pencil-plus-outline fs-1 me-2 text-primary"></i>
          </div>
  ...
  <section id="detail" class="my-5 py-5">
    <div class="container">
      ...
      <div class="row gy-5">
        <div class="col-lg-5">
          <div class="text-center">
            <img src="<?php echo e(asset('materio/assets/img/illustrations/misc-under-maintenance.png')); ?>"
