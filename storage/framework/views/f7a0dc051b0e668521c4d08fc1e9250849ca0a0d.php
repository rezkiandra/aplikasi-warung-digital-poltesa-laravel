<?php if($type == 'select'): ?>
  <select class="form-select" id="<?php echo e($name); ?>" name="<?php echo e($name); ?>">
...
<?php /**PATH C:\laragon\www\warungdigital\resources\views/components/input-form-label.blade.php ENDPATH**/ ?>