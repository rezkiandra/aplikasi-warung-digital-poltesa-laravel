          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <a class="me-2" href="<?php echo e(route('admin.edit.customer', $data->uuid)); ?>">
...
<?php $component = $__env->getContainer()->make(App\View\Components\DropdownItem::class, ['label' => 'Detail','variant' => 'secondary','icon' => 'eye-outline','route' => route('admin.detail.customer', $data->slug)]); ?>
...
<?php endif; ?>
                    <form action="<?php echo e(route('admin.destroy.customer', $data->uuid)); ?>" method="POST">
                      <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/components/customer/customer-table.blade.php ENDPATH**/ ?>