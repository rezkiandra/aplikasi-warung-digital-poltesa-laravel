...
<?php $component = $__env->getContainer()->make(App\View\Components\EditForm::class, ['title' => 'Edit specific product','action' => route('admin.update.product', $product->slug),'route' => route('admin.products'),'class' => 'col-lg-10']); ?>
...
<?php $component->withAttributes([]); ?>
            <select name="seller_id" id="seller_id" class="form-select">
              <option value="<?php echo e($product->seller_id); ?>" selected><?php echo e($product->seller->full_name); ?></option>
              <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($key == $product->seller_id): ?>
                  <?php continue; ?>
                <?php endif; ?>
                <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes([]); ?>
            <?php if (isset($component)) { $__componentOriginale1bb2929f8b9df6873fa722ef130c57617d11754 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Description','name' => 'description','type' => 'textarea','value' => $product->description,'placeholder' => 'This product contain 1000mg vitamin c']); ?>
<?php $component->withName('input-form-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>