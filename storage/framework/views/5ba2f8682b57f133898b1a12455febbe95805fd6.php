...
<?php $component->withAttributes([]); ?>
				<?php if (isset($component)) { $__componentOriginale1bb2929f8b9df6873fa722ef130c57617d11754 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Confirm Password','name' => 'konfirmasi','type' => 'password','placeholder' => 'Confirm password','value' => old('konfirmasi')]); ?>
<?php $component->withName('input-form-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mb-3')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\FormCheck::class, ['class' => 'mb-3','label' => 'I aggree to our terms and conditions','name' => 'terms','type' => 'checkbox','value' => old('terms')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\SubmitButton::class, ['label' => 'Sign Up','type' => 'submit','variant' => 'primary','icon' => 'account-plus-outline','class' => 'w-100']); ?>
...
<?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/components/auth/register.blade.php ENDPATH**/ ?>