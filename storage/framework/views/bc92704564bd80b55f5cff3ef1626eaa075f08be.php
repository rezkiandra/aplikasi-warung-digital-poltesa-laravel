...
<?php $component = $__env->getContainer()->make(App\View\Components\CreateForm::class, ['title' => 'Create new role','action' => route('admin.store.role'),'route' => route('admin.roles')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Role Name','name' => 'role_name','type' => 'text','placeholder' => 'Ex: Admin, Superadmin, Editor, etc','value' => old('role_name')]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>