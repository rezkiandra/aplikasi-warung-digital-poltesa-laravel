...
<?php $component = $__env->getContainer()->make(App\View\Components\CreateForm::class, ['title' => 'Tambah role baru','action' => route('admin.store.role'),'route' => route('admin.roles')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Nama Role','name' => 'role_name','type' => 'text','placeholder' => 'Superadmin, Editor, Maintainer','value' => old('role_name')]); ?>
