...
<?php $component = $__env->getContainer()->make(App\View\Components\EditForm::class, ['title' => 'Edit spesifik pengguna','action' => route('admin.update.user', $user->uuid),'route' => route('admin.users'),'class' => 'col-lg-12']); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>