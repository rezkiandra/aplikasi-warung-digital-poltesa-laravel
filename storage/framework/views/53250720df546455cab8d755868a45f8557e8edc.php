...
<?php $component = $__env->getContainer()->make(App\View\Components\CreateForm::class, ['title' => 'Add biodata','action' => route('customer.store.biodata'),'route' => route('customer.biodata')]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/customer/biodata.blade.php ENDPATH**/ ?>