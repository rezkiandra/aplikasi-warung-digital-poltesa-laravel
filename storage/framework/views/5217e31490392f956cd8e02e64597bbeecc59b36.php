...
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Nama Bank','name' => 'bank_name','type' => 'text','placeholder' => 'Ex: BCA, Mandiri, BRI, etc','value' => $bank->bank_name]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/bank_account/edit.blade.php ENDPATH**/ ?>