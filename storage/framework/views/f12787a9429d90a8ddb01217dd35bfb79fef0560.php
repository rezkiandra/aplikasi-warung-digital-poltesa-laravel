...
<?php $component = $__env->getContainer()->make(App\View\Components\CreateForm::class, ['title' => 'Tambah bank baru','action' => route('admin.store.bank'),'route' => route('admin.bank_accounts')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Nama Bank','name' => 'bank_name','type' => 'text','placeholder' => 'BCA, Mandiri, BRI','value' => old('bank_name')]); ?>
