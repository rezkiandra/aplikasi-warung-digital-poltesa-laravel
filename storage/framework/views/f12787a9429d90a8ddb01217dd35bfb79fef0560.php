...
<?php $component = $__env->getContainer()->make(App\View\Components\CreateForm::class, ['title' => 'Create new bank','action' => route('admin.store.bank'),'route' => route('admin.bank_accounts')]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\InputFormLabel::class, ['label' => 'Bank Name','name' => 'bank_name','type' => 'text','placeholder' => 'Ex: BCA, Mandiri, BRI, etc','value' => old('bank_name')]); ?>
...
<?php echo $__env->make('layouts.authenticated', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Desktop\warungdigital\resources\views/admin/bank_account/create.blade.php ENDPATH**/ ?>